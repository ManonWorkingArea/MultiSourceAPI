...
module.exports = function (clientConfig) {
    ...
    // Use clientConfig.connection.URI instead of hardcoded string
    mongoose.connect(clientConfig.connection.URI, {
    ...
    router.get('/:collection/:id', async (req, res) => {
        ...
        if (joinCollection && arrayField) {
            const joinColl = mongoose.connection.db.collection(joinCollection);
